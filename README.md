...
**Description**: create an app that can upload and convert CSV files into JSON files that can then be downloaded again 
...
```sh
git clone https://github.com/GPT-Engineer-App/csv2jsonify.git
cd csv2jsonify
npm i
